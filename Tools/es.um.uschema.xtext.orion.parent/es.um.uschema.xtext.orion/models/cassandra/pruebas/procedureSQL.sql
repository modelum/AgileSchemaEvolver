...
BEGIN
  ...
  -- (2) Insertar comandos para eliminar claves foráneas propias
  INSERT INTO tmp_fks (cmd)
    SELECT DISTINCT 
  ...
  -- (3) Ejecutar comandos de eliminación y limpiar
  CALL executeCommand();
END$$
...
BEGIN
  ...
  -- (2) Insert statements to drop foreign keys
  INSERT INTO tmp_fks (cmd)
...
BEGIN
  -- Variables and cursor declared at the beginning (MySQL requirement):
  DECLARE done INT DEFAULT 0;
